...
namespace PethanyApplication.Migrations
{
    ...
    [Migration("20210520093801_add-order-to-database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PethanyApplication.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("PethanyApplication.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("PethanyApplication.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("PethanyApplication.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PethanyApplication.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("PethanyApplication.Models.OrderDetail", b =>
                {
                    b.HasOne("PethanyApplication.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PethanyApplication.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PethanyApplication.Models.Pie", b =>
                {
                    b.HasOne("PethanyApplication.Models.Category", "Category")
                        .WithMany("Pies")
